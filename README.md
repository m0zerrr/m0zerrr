...
Я начинающий _аналитик данных_ из Новосибирска `(без профессионального опыта)`.  Ищу стажировку, которую смогу совмещать с учёбой на 3 курсе
...
Всю сознательную жизнь мне нравится:
- 🔍 подмечать зависимости между явлениями
- 🧩 находить пути решения в задачах (учебных и практических)
- 💻 программировать — это расширило мои возможности
...
+ 📊 Умею строить дашборды
+ ❗ Учусь выявлять требования к информационным системам
+ 💼 Нахожусь в поиске стажировки/работы, которую смогу совмещать с учёбой

📬 Как связаться со мной: [![Telegram Badge](https://img.shields.io/badge/mozcoff-blue?style=flat-square&logo=telegram&logoColor=white)
...
<div>
  ...
  <div>
    ...
    <img src="https://images.icon-icons.com/3053/PNG/512/microsoft_excel_macos_bigsur_icon_189980.png" width="45"/>
    <img src="https://github.com/microsoft/PowerBI-Icons/blob/main/SVG/Power-BI.svg" width="30"/>
  </div>
  <div>
    <img src="https://img.shields.io/badge/OOP-purple?style=flat">
    <img src="https://img.shields.io/badge/pandas-white?style=flat&logo=pandas&logoColor=darkblue">
    <img src="https://img.shields.io/badge/sklearn-blue?style=flat&logo=scikitlearn&logoColor=orange">
  </div>
  <p>🤏 А также знаком с:</p>
